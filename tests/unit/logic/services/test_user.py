...
class TestUserService:
    async def test_add_user_correct(self, user_service_with_data, new_user_dto, new_user_model):
    ...
    async def test_add_user_correct_event(self, user_service_with_data, new_user_dto, new_user_model):
        new_user = await user_service_with_data.add_user(new_user_dto)
